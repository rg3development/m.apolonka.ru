...
class Catalog_Item extends MY_Model_Catalog
{
    ...
    public function image_mid ()
    {
        ...
        return $this->img_src_mid($image);
    }
    public function image_mid_all ()
    {
        $image = NULL;
        if ( $this->id )
        {
            $catalog_mapper = new Catalog_Mapper();
            $image = $catalog_mapper->get_images($this->id);
        }
        foreach($image as $key => $img){
            $images[$key]=$this->img_src_big($img);
        }
        return $images;
    }
    ...
    {
        $image_src = '/../www_site/img/noimg.png';
        ...
        public function img_src_mid ( $img_obj, $full_url = FALSE )
    {
        $image_src = '/../www_site/img/noimg.png';
        if ( $img_obj && $img_obj->image_id )
        {
            ...
            if ( $full_url )
            {
                $image_src = 'http://apolonka.ru/pphoto/mid/' . $image->getFilename();
            } else {
                $image_src = 'http://apolonka.ru/pphoto/mid/' . $image->getFilename();
            }
        }
        return $image_src;
            ...
            public function img_src_big ( $img_obj, $full_url = FALSE )
    {
        $image_src = '/../www_site/img/noimg.png';
        if ( $img_obj && $img_obj->image_id )
        {
            ...
            if ( $full_url )
            {
                $image_src = 'http://apolonka.ru/pphoto/big/' . $image->getFilename();
            } else {
                $image_src = 'http://apolonka.ru/pphoto/big/' . $image->getFilename();
            }
        }
    ...
    public function img_src_sm ( $img_obj, $full_url = FALSE )
    {
        $image_src = '/../www_site/img/noimg.png';
        if ( $img_obj && $img_obj->image_id )
        {
            ...
            if ( $full_url )
            {
                $image_src = 'http://apolonka.ru/pphoto/sm/' . $image->getFilename();
            } else {
                $image_src = 'http://apolonka.ru/pphoto/sm/' . $image->getFilename();
            }
        }
