            ...
            if ( $_REQUEST['type'] == 'save' )
            {
                ...
                if ( $this->form_validation->run() )
                {
                    ...
                    if ( $total )
                    {
                        ...
                        // save order
                        $order_data = array();
                        $order_data['full_name']       = $_REQUEST['full_name'];
                        $order_data['phone']           = $_REQUEST['phone'];
                        $order_data['address']         = '';//$this->input->$_REQUEST['address'];
                        ...
                        $order_data['delivery']    = $_REQUEST['delivery'];
                        ...
                        $this->_send_mails($_REQUEST['email'], $order_id, $total_price);
                        $this->cart->destroy();
                    } else {
    ...
    private function _send_mails ( $user_email, $order_id, $total_price )
    {
        ...
        $purchases .= "
            <tr>
                ...
                <td></td>
                <td></td>
                <td>" . $this->cart->format_number($total_price + $delivery['cost'] ). "</td>
            </tr>
        ";
        $purchases .= '</table><br/>';
